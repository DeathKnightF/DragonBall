...
//		setUndecorated(true);
		...
		JCheckBox selectSizeButton1=new JCheckBox("half screen");
		JCheckBox selectSizeButton2=new JCheckBox("Full screen(For surface)");
		JCheckBox selectControlButton1=new JCheckBox("Mouse control");
		JCheckBox selectControlButton2=new JCheckBox("Keyboard control");
		...
		selectSizeButton1.setFont(new Font("SansSerif",Font.BOLD,40));
		...
		selectSizeButton2.setBounds(Data.SET_DIALOG_SELECT_BUTTON_POSITION_X2,
				...
				Data.SET_DIALOG_SELECT_BUTTON_WIDTH,
				Data.SET_DIALOG_SELECT_BUTTON_HEIGHT);
		selectSizeButton2.setFont(new Font("SansSerif",Font.BOLD,40));
		...
		selectControlButton1.setBounds(Data.SET_DIALOG_SELECT_BUTTON_POSITION_X1,
				...
				Data.SET_DIALOG_SELECT_BUTTON_WIDTH,
				Data.SET_DIALOG_SELECT_BUTTON_HEIGHT);
		selectControlButton1.setFont(new Font("SansSerif",Font.BOLD,40));
		...
		selectControlButton2.setBounds(Data.SET_DIALOG_SELECT_BUTTON_POSITION_X2,
				...
				Data.SET_DIALOG_SELECT_BUTTON_WIDTH,
				Data.SET_DIALOG_SELECT_BUTTON_HEIGHT);
		selectControlButton2.setFont(new Font("SansSerif",Font.BOLD,40));
		...
		conFirmButton.setBounds(Data.SET_DIALOG_SELECT_BUTTON_POSITION_X1,
				...
				Data.SET_DIALOG_SELECT_BUTTON_WIDTH,
				Data.SET_DIALOG_SELECT_BUTTON_HEIGHT);
		conFirmButton.setFont(new Font("SansSerif",Font.BOLD,40));
					...
					public void run() {
						try {
							if(selectSizeButton2.isSelected()&&!selectSizeButton1.isSelected()) {
								...
								Data.MAIN_MENU_FRAME_BUTTON_WIDTH=WINDOW_WIDTH/4;//�����水ť���
								Data.MAIN_MENU_FRAME_BUTTON_HEIGHT=WINDOW_HEIGHT/10;
								Data.SKILL_BUTTON_WIDTH=Data.MENU_BUTTON_WIDTH;
								Data.SKILL_BUTTON_HEIGHT=Data.SKILL_BUTTON_WIDTH;
								Data.SKILL_BUTTON_POSITION_X=0;
								Data.SKILL_BUTTON_POSITION_Y=WINDOW_HEIGHT-Data.SKILL_BUTTON_HEIGHT;
								...
								Data.CHOOSE_PLAYER_PLANE_FRAME_DATA_STRIP_STANDARD_WIDTH=WINDOW_WIDTH/4;//������
								...
								Data.CHOOSE_BOSS_BUTTON_INTERVAL_X=WINDOW_WIDTH*3/8;//ˮƽ���
								...
								Data.PLAYER_START_X=WINDOW_WIDTH/2-30;//��ʼ����
								Data.PLAYER_START_Y=WINDOW_HEIGHT-130;
								Data.PLAYER_WIDTH=WINDOW_WIDTH/15;
		...
		cancelButton.setBounds(Data.SET_DIALOG_SELECT_BUTTON_POSITION_X2,
				...
				Data.SET_DIALOG_SELECT_BUTTON_WIDTH,
				Data.SET_DIALOG_SELECT_BUTTON_HEIGHT);
		cancelButton.setFont(new Font("SansSerif",Font.BOLD,40));
