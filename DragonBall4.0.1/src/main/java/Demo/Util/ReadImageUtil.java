...
public class ReadImageUtil {
	...
	public static Image coolingImg;
	public static Image circleShield;
	public static Image coinsImg;
	...
	public static Image fireworkImg;
	...
	public static Image[] mainMenuFrameBg;
	...
	public static Image storePower;
	public static Image storePowerMax;
	public static Image shield;
	public static Image signInFrameImg;
	...
	static {
		...
		for(int i=0;i<11;i++)
			atomicBombExplodeImgs[i]=(new ImageIcon(("Imgs/explodeImg/ae"+(i+1)+".png"))).getImage();
		...
		bulletImg=new ImageIcon("Imgs/ShellsImg/bullet.png").getImage();
		//boss���
		for(int i=1;i<=4;i++)
		...
		coolingImg=new ImageIcon("Imgs/prop/cooling.png").getImage();
		...
		circleShield=new ImageIcon("Imgs/prop/circleShield.png").getImage();
		coinsImg=new ImageIcon("Imgs/backgroundImg/coins.png").getImage();
		...
		fireworkImg=new ImageIcon("Imgs/ShellsImg/firework.png").getImage();
		...
		mainMenuFrameBg=new Image[5];
		for(int i=0;i<5;i++)
			mainMenuFrameBg[i]=new ImageIcon("Imgs/backgroundImg/MainMenuFrame/MainMenuFrameBg"+i+".jpg").getImage();
		...
		laserImg=new ImageIcon("Imgs/ShellsImg/Laser.png").getImage();
		
		shield = new ImageIcon("Imgs/prop/shield.png").getImage();
		...
		storePower=new ImageIcon("Imgs/prop/storePower.png").getImage();
		storePowerMax=new ImageIcon("Imgs/prop/storePowerMax.png").getImage();
		signInFrameImg=new ImageIcon("Imgs/backgroundImg/SignInFrame.jpg").getImage();
